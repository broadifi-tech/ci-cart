            ...
            <div class="box-body">
                <div class="row clearfix">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <textarea rows="4" name="details" class="form-control" id="details" ><?php echo $category->details; ?></textarea>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <input type="checkbox" name="status" <?php echo $category->status?'checked':'';?> value="1"  id="status" />
